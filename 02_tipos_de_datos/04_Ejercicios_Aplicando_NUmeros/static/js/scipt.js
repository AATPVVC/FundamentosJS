...
function compraDescuento() {
    let compra = 25000;
    alert(`el precio es $${compra}
        \nEl descuento del 20%: $${compra * 0.2}
        \nEl precio con descuento es: $${compra - (compra * 0.20)} `);
};
